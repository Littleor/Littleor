...
- 🏆 My current research interests focus on **AI for Creativity**, including **Multimodal LLM**, **Generative AI(Image/Music)** and **Affective Computing**. At the same time, I have researched on the **Meta-learning** and **HCI** on the side. The publications are available at my [homepage](https://littleor.github.io/).
